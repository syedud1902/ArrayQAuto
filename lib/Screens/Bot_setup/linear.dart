...
class LinearTemplate {
  ...
  LinearTemplate(this.title);
}

final List<LinearTemplate> templateList = [
  LinearTemplate('Default Template'),
  LinearTemplate('Default Template'),
  LinearTemplate('Default Template'),
  LinearTemplate('Default Template'),
];
...
class LinearPage extends StatefulWidget {
  const LinearPage({Key key}) : super(key: key);
...
class _LinearPageState extends State<LinearPage> {
  ...
  TextEditingController _linearController = TextEditingController();
  ...
  void insertItem(String title) {
    final newIndex = 0;
    final newItem = LinearTemplate(title);
                    ...
                    onTap: () => showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        actions: [
                          TextButton(
                            onPressed: () {
                              _linearController.text.isEmpty
                                  ? null
                                  : insertItem(_linearController.text);
                              Navigator.pop(context);
                            },
                            child: Text(
                              'OK',
